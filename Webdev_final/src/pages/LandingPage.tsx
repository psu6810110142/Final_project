...
const LandingPage: React.FC = () => {
  ...
  // degreeMap — map instructor_id กับข้อมูลมหา'ลัยและโลโก้จาก assets
    ...
    <div className={`page-wrapper ${theme === 'ocean' ? 'ocean-page' : ''}`}>
      ...
      <section className="snap-section features-snap">
        <div className="container">
          ...
          {/* FIX #5 — ขยายการ์ด why-grid */}
          <div className="why-grid why-grid-lg">
            {[
              {
                icon:'🏆', color:'#1565c0', bg:'linear-gradient(135deg,#e3f2fd,#bbdefb)',
                title:'การันตีคุณภาพผู้สอน',
                bullets:['ดีกรีระดับปริญญาโทขึ้นไป','ประสบการณ์สอนกว่า 10 ปี','ผ่านการคัดเลือกเข้มข้น'],
              },
              {
                icon:'💰', color:'#2e7d32', bg:'linear-gradient(135deg,#e8f5e9,#c8e6c9)',
                title:'ประหยัดกว่าเรียนพิเศษ',
                bullets:['ลดค่าใช้จ่ายเดินทาง 100%','ราคาถูกกว่าติวเตอร์ที่บ้าน 60%','จ่ายครั้งเดียวดูได้ตลอด'],
              },
              {
                icon:'📱', color:'#e65100', bg:'linear-gradient(135deg,#fff3e0,#ffe0b2)',
                title:'เรียนได้ทุกที่ทุกเวลา',
                bullets:['รองรับมือถือ แท็บเล็ต คอม','ดูซ้ำได้ไม่จำกัดครั้ง','ไม่มีวันหมดอายุ'],
              },
              {
                icon:'🏅', color:'#6a1b9a', bg:'linear-gradient(135deg,#f3e5f5,#e1bee7)',
                title:'รับใบเซอร์ทุกคอร์ส',
                bullets:['ใบรับรองจากสถาบัน NLA','เพิ่มพอร์ตโฟลิโอนักเรียน','ออกให้ทุกคอร์สที่เรียนจบ'],
              },
            ].map((f,i) => (
      ...
      <section className="snap-section instructors-snap">
        <div className="container">
          <Reveal>
            ...
            <p style={{ textAlign:'center', color:'rgba(255,255,255,.75)', marginBottom:'36px' }}>
              ทุกคนผ่านการคัดเลือกและมีประสบการณ์การสอนจริง
            </p>
          </Reveal>
          <div className="instructors-grid">
            {instructors.length > 0 ? instructors.slice(0,4).map((inst, i) => {
              const d = degreeMap[inst.instructor_id] || {
                ...
                universityLogo: PSULogo,
                faculty: 'คณะศึกษาศาสตร์',
                honor: '🏅 เกียรตินิยมอันดับ 1',
                exp: 'ประสบการณ์สอนกว่า 8 ปี',
              };
              return (
                  ...
                  <div className="instructor-card instructor-card-white">
                    ...
                    <div className="instructor-avatar-wrap">
                      <img src={getImageUrl(inst.profile_image_url)} alt={inst.name}
                        ...
                        onError={e => (e.currentTarget.src = GrayLogo)} />
          ...
          <Reveal>
            <div className="promo-banner">
              <div className="promo-left">
                {/* FIX #8 — promo-tag ซ้าย เห็นชัดขึ้น */}
              ...
              <div className="promo-right">
                {/* FIX #9 — promo-countdown ขวา เห็นชัดขึ้น */}
        ...
        <div className="container">
          <Reveal>
            <div style={{ textAlign:'center', marginBottom:'12px' }}>
              {/* FIX #10 — popular-badge-big ขยายให้ใหญ่ขึ้น */}
              ...
              <Reveal key={i} delay={i*150} dir="up">
                <div className="review-card">
                  ...
                  <div className="review-author">
                    <img
                      src={`https://i.pravatar.cc/60?img=${r.seed}`}
                      alt={r.name}
                      className="review-real-avatar"
        ...
        <div className="container" style={{ display:'flex', justifyContent:'center', position:'relative', zIndex:10 }}>
          <Reveal dir="up">
            <div style={{ display:'flex', flexDirection:'column', alignItems:'center', textAlign:'center' }}>
              ...
              <p style={{ color:'rgba(255,255,255,.85)', marginBottom:'32px', fontSize:'1.1rem' }}>
                สมัครวันนี้ เริ่มเรียนได้ทันที ไม่มีค่าสมัคร
              </p>
              <div style={{ display:'flex', gap:'16px', flexWrap:'wrap', justifyContent:'center', marginBottom:'32px' }}>
                {/* FIX #11 — ปุ่มสมัครสมาชิกฟรี */}
